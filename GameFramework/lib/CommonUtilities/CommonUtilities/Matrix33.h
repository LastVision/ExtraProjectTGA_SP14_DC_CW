...
namespace CommonUtilities
{
	...
	{
		Matrix33<Type> tempMatrix;
		CU::Vector3<Type> rowVector1;
		CU::Vector3<Type> rowVector2;
		CU::Vector3<Type> rowVector3;
		CU::Vector3<Type> colVector1;
		CU::Vector3<Type> colVector2;
		CU::Vector3<Type> colVector3;
		...
		colVector1.y = aRightHandedMatrix.myMatrix[1];
		colVector1.z = aRightHandedMatrix.myMatrix[2];
		colVector2.x = aRightHandedMatrix.myMatrix[3];
		colVector2.y = aRightHandedMatrix.myMatrix[4];
		colVector2.z = aRightHandedMatrix.myMatrix[5];
		colVector3.x = aRightHandedMatrix.myMatrix[6];
		colVector3.y = aRightHandedMatrix.myMatrix[7];
...
template class CU::Matrix33 < int > ;